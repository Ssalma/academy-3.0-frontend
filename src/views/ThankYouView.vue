        ...
        <div class="right">
            ...
            <div class="show-before">
                <figure>
                    ...
                    <figcaption>We have received your assessment test, we will get back to you soon. <br>
                                        Best of luck</figcaption>
                    <router-link :to="{ name: 'home'}"><app-button class="home-btn finish-button-center" :text="Button.Home"></app-button></router-link>
                </figure>
            </div>
...
export default {
    ...
    data(){
        return{
            Button: { nextButton: "Next", previousButton: "Previous", finishButton: "Finish", TakeAssessment: "Take Assessment", Home: "Home"},
            selectedAnswer: "",
        };
    },
    methods: {
